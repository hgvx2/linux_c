...
${OBJECTDIR}/_ext/4e21f46f/UdpEpoll.o: ../common/epoll/UdpEpoll.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4e21f46f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4e21f46f/UdpEpoll.o ../common/epoll/UdpEpoll.cpp
...
${OBJECTDIR}/_ext/35be9bb4/UdpSrv.o: ../common/srv/udp/UdpSrv.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/35be9bb4/UdpSrv.o ../common/srv/udp/UdpSrv.cpp

${OBJECTDIR}/_ext/6616ec4c/UdpSrvBase.o: ../common/srv/udp/base/UdpSrvBase.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/6616ec4c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6616ec4c/UdpSrvBase.o ../common/srv/udp/base/UdpSrvBase.cpp

${OBJECTDIR}/_ext/c9ca406/UdpSrvTask.o: ../common/srv/udp/udp_srv_task/UdpSrvTask.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/c9ca406
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c9ca406/UdpSrvTask.o ../common/srv/udp/udp_srv_task/UdpSrvTask.cpp

${OBJECTDIR}/_ext/c9ca406/UdpSrvTaskManager.o: ../common/srv/udp/udp_srv_task/UdpSrvTaskManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/c9ca406
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c9ca406/UdpSrvTaskManager.o ../common/srv/udp/udp_srv_task/UdpSrvTaskManager.cpp
